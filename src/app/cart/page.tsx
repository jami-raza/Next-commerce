  ...
  return (
    <div className=" mx-auto mt-10">
      <div className="flex flex-wrap shadow-md my-10 mx-2 max-lg:block">
        <div className="w-3/4 bg-white px-10 py-10 max-lg:w-full max-md:p-4">
                ...
                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" key={el.product_id}>
                  <div className="flex w-2/5 max-md:block max-md:w-full">
                    ...
                    <div className="flex flex-col justify-between ml-4 flex-grow max-md:ml-0">
                      <span className="font-bold text-sm max-sm:hidden">{el.title}</span>
                      ...
                      <button onClick={() => dispatch(removeToCart(el.product_id))} className="m-2 w-fit">
                        <svg width="20px" height="20px" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <rect width="48" height="48" fill="white" fill-opacity="0.01"></rect> <path d="M9 10V44H39V10H9Z" fill="#ff0000" stroke="#ff0000" stroke-width="4" stroke-linejoin="round"></path> <path d="M20 20V33" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M28 20V33" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M4 10H44" stroke="#ff0000" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M16 10L19.289 4H28.7771L32 10H16Z" fill="#ff0000" stroke="#ff0000" stroke-width="4" stroke-linejoin="round"></path> </g></svg>
                      </button>
                    </div>
                  </div>
                  <div className="flex justify-center w-1/5 max-md:w-full max-md:justify-end">
                    ...
                    <input className="mx-2 border text-center w-8" type="text" value={el.qty} />
